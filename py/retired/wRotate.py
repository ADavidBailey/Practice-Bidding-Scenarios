...
PBS_PBN_ROTATED = "P:\\pbn-rotated-for-4-players"

def rotate_deal(file_path,filename):
     with open(input_file_path, 'r') as file:
        content = file.read()
        processed_text = rotate_hand(content)
        output_file_path = "P:\\pbn-rotated-for-4-players\\" + filename

        with open(output_file_path, 'w') as output_file:
            # Save the processed text to the pbn-rotated-for-4-players folder
