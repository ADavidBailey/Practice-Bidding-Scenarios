...
:: BBA.exe --HAND %inputFilePath% --ARCHIVE_FILE %outputFilePath% --CC1 P:\bbsa\%conventionCard%.bbsa --CC2 P:\bbsa\21GF-DEFAULT.bbsa --ARCHIVE_TYPE 4 --DD 0 --SD 1 --AUTOBID --AUTOCLOSE > nul

BBA.exe --HAND %inputFilePath% --ARCHIVE_FILE %outputFilePath% --CC1 P:\bbsa\%conventionCard%.bbsa --CC2 P:\bbsa\21GF-GIB.bbsa --ARCHIVE_TYPE 4 --DD 0 --SD 1 --AUTOBID --AUTOCLOSE > nul
